...
void WaterSensor::setup() { wiringPiSetup(); }

std::string WaterSensor::communicate(std::string UNUSED(message)) {
...
std::string WaterSensor::getConfig() { return "{}"; }
...
void WaterSensor::receiveMessage(std::string UNUSED(message)) {}
