...
void Flame::setup() { wiringPiSetup(); }

std::string Flame::communicate(std::string UNUSED(message)) {
...
std::string Flame::getConfig() { return "{}"; }
...
void Flame::receiveMessage(std::string UNUSED(message)) {}
