...
void Dht11::doWork() {
    if (alarm) {
        measure();
        if (this->temperature > this->maxtemp || this->temperature < this->mintemp) {
...
std::string Dht11::communicate(std::string message) {
...
void Dht11::receiveMessage(std::string message) {
}
