...
void EMail::doWork() { std::this_thread::sleep_for(std::chrono::seconds(1)); }

void EMail::setup() {}

std::string EMail::communicate(std::string UNUSED(message)) {
  return "NOTSUPPORTED";
}
...
std::string EMail::getConfig() { return "{}"; }
